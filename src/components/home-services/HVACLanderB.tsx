...
export default function HVACLanderB() {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      tcpa_text: 'By clicking the button, I agree to receive calls and texts at the number provided about my project.',
    ...
    <form onSubmit={(e) => e.preventDefault()} className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50">
      ...
      <footer className="mt-auto pt-4 pb-4 border-t border-gray-100">
        <div className="text-center space-y-2">
          ...
          <p className="text-[10px] text-gray-300">© {new Date().getFullYear()} SellingProperty.net</p>
        </div>
      </footer>
    </form>
  );
