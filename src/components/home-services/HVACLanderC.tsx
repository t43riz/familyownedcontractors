...
const StepAddress = ({ answers, handleAnswer, onNext }: any) => {
  ...
  return (
    <StepCard icon={<MapPin className="h-5 w-5" />} title="Property Address" subtitle="For local contractor matching">
      ...
      <Button onClick={onNext} disabled={!canProceed || justSelected} className="w-full mt-3 py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-semibold">
